<p>
    <a href="<?php base_url(); ?>assets/img/albums_cover/<?php echo $cover_img; ?>">
    <img class="size-thumbnail wp-image-102 alignleft" title="cover" src="<?php base_url(); ?>assets/img/albums_cover/<?php echo $thumb_img; ?>" alt="" width="150" height="150" />
